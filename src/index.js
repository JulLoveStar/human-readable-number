module.exports = function toReadable(number) {
    ...
    if(number.length ===1 && Number(number[0]) >0){
        ...
        // console.log(result)
        return result
    } else if(number.length === 2 && Number(number[0])>=2 && Number(number[1])!=0){
        result = dozen[number[0]] +" "+ unit[number[1]]
        // console.log(result)
        return result
    } else if(number.length === 2 && Number(number[0])>=2 && Number(number[1])===0){
        result = dozen[number[0]]
        // console.log(result)
        return result
    }else if(number.length === 3 && Number(number[1])>1 && Number(number[2])!=0){
        ...
        // console.log(result)
        return result
    } else if(number.length === 3 && Number(number[1])===0 && Number(number[2])>0){
        result = unit[number[0]]+' hundred '+ unit[number[2]]
        return result
    } else if(number.length === 3 && Number(number[1])>1 && Number(number[2])===0){
        result = unit[number[0]]+' hundred '+dozen[number[1]]
        // console.log(result)
        return result
    }else if(number.length === 3 && Number(number[1])===0 && Number(number[2])===0){
